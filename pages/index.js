...
const handleDownload = async () => {
  if (prediction && prediction.output && prediction.output.length > 0) {
    try {
      ...
      instructionsDiv.innerHTML = '<p>ပုံကို download လုပ်ရန် ပုံပေါ်ကို ဖိထားပြီး  Save ဖြစ်ဖြစ် Save Image As နဲ့ဖြစ်ဖြစ် သိမ်းပါ။ Facebook ကနေဆိုရင် သိမ်းမရပါ။ web browser နဲ့ app ကနေသုံးပါ။ \'Save Image As...\'.</p>';
